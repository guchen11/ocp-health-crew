                    ...
                    <div class="card-body">
                        <div style="margin-bottom:12px;">
                            ...
                            <span style="font-size:12px;color:var(--text-secondary);margin-top:6px;display:block;">
                                💡 Leave empty to use default kubeconfig, or enter the bastion/server hostname to connect via SSH
                            </span>
                        </div>
                    </div>
                </div>
...
✅ Result: New test automatically added to suite!</code></pre>
                ...
                <table>
                    ...
                    <tr><td><code>RH_LAB_HOST</code></td><td>SSH target hostname</td><td>bastion.example.com</td></tr>
