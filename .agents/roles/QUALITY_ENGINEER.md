...
## Stack-Specific Quality Tools: Python / Flask

- Verify no bare `except:` without specific reason
- Verify no string interpolation for shell/SSH commands
- Verify no secrets, passwords, or tokens in code or config
- Verify error messages include what, where, why, and how to fix
- Verify file size limits (500 lines per file, 50 lines per function)
- Verify SSH output is sanitized before logging
